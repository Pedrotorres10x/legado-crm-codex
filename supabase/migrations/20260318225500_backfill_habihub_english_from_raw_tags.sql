  ...
  select
    ...
    left(
      coalesce(
        ...
        public.extract_habihub_localized_text(source_metadata->'raw_tags'->'desc'->>0, 'desc', 'en'),
        public.extract_habihub_localized_text(source_metadata->'raw_tags'->'description'->>0, 'description', 'en'),
    ...
    nullif(
      coalesce(
        ...
        public.extract_habihub_localized_text(source_metadata->'raw_tags'->'title'->>0, 'title', 'en'),
        public.extract_habihub_localized_text(source_metadata->'raw_tags'->'name'->>0, 'name', 'en'),
        public.extract_habihub_localized_text(source_metadata->'raw_tags'->'headline'->>0, 'headline', 'en'),
